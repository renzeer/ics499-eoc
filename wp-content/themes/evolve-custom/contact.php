...
if(isset($_POST['submit'])) {
	...
	if((function_exists('recaptcha_get_html')) && ($evolve_recaptcha_public && $evolve_recaptcha_private)) {
		$resp = recaptcha_check_answer ($evolve_recaptcha_private,
                                $_SERVER["REMOTE_ADDR"],
...
?>
    ...
    <?php if ( have_posts() ) : ?>
          ...
          <div class="clearfix"></div>
					...
					<?php if((function_exists('recaptcha_get_html')) && ($evolve_recaptcha_public && $evolve_recaptcha_private)): ?>

					<div id="comment-recaptcha">

					<?php echo recaptcha_get_html($evolve_recaptcha_public); ?>
