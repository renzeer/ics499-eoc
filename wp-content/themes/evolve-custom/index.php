...
?>
  ...
  <?php endif; ?>
    ...
    <?php } ?>  
			...
			<!--BEGIN #primary .hfeed-->
			<div id="primary" class="<?php if ($evolve_layout == "1c") {echo ' col-md-12';} 
      
      else {echo ' col-xs-12 col-sm-6'; if (($evolve_layout == "2cr" && ($evolve_post_layout == "two") || $evolve_layout == "2cl" && ($evolve_post_layout == "two"))) { echo ' col-md-10';}  if (($evolve_layout == "3cm" || $evolve_layout == "3cl" || $evolve_layout == "3cr")) {echo ' col-md-6';} else {echo ' col-md-10'; }  if ( is_single() || is_page() ) { echo ' col-single';  } } ?>
 ...
 <?php if (is_attachment()) { ?>
     ...
     <?php if ( have_posts() ) : ?>
        ...
        <h1 class="entry-title"><a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment" class="attach-font"><?php echo get_the_title($post->post_parent); ?></a> &raquo; <?php //if ( get_the_title() ){ the_title();} ?></h1>
...
echo evltruncate($title, $evolve_posts_excerpt_title_length, '...'); } ?></a>  
