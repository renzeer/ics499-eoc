...
if ($evolve_bootstrap_slide_1 == "1") {
      ...
      echo "<img class='img-responsive' src='".$evolve_bootstrap_slide1_img."' alt='' />";
...
if ($evolve_bootstrap_slide_2 == "1") {
      ...
      echo "<img class='img-responsive' src='".$evolve_bootstrap_slide2_img."' alt='' />"; 
...
if ($evolve_bootstrap_slide_3 == "1") {
      ...
      echo "<img class='img-responsive' src='".$evolve_bootstrap_slide3_img."' alt='' />";
...
if ($evolve_bootstrap_slide_4 == "1") {
      ...
      echo "<img class='img-responsive' src='".$evolve_bootstrap_slide4_img."' alt='' />";   
...
if ($evolve_bootstrap_slide_5 == "1") {
      ...
      echo "<img class='img-responsive' src='".$evolve_bootstrap_slide5_img."' alt='' />";  
...
if ($evolve_slide_1 == "1") {
      ...
      echo "<div class='da-img'><img class='img-responsive' src='".$evolve_slide1_img."' alt='' /></div>";
...
if ($evolve_slide_2 == "1") {
      ...
      echo "<div class='da-img'><img class='img-responsive' src='".$evolve_slide2_img."' alt='' /></div>";
...
if ($evolve_slide_3 == "1") {
      ...
      echo "<div class='da-img'><img class='img-responsive' src='".$evolve_slide3_img."' alt='' /></div>";
...
if ($evolve_slide_4 == "1") {
      ...
      echo "<div class='da-img'><img class='img-responsive' src='".$evolve_slide4_img."' alt='' /></div>";
...
if ($evolve_slide_5 == "1") {
      ...
      echo "<div class='da-img'><img class='img-responsive' src='".$evolve_slide5_img."' alt='' /></div>";
...
if ($evolve_content_boxes == "1") {   
      ...
      $evolve_content_box1_desc = evolve_get_option('evl_content_box1_desc','Clean and modern theme with smooth and pixel perfect design');if ($evolve_content_box1_desc === false) $evolve_content_box1_desc = '';
