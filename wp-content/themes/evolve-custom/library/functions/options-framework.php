...
function evolve_load_styles() {
	...
	wp_enqueue_style('color-picker', EVOLVE_DIRECTORY.'css/colorpicker.css');
  wp_enqueue_style('thickbox', site_url() . '/' . WPINC . '/js/thickbox/thickbox.css');
  wp_enqueue_style('google-fonts', "//fonts.googleapis.com/css?family=Oswald:r,b|Cabin:r,b,i");
}	
...
function evolve_load_scripts() {
  ...
  wp_enqueue_script('jquery-ui-tabs');  
	...
	wp_enqueue_script('color-picker', EVOLVE_DIRECTORY.'js/colorpicker.js', array('jquery'));
	wp_enqueue_script('options-custom', EVOLVE_DIRECTORY.'js/options-custom.js', array('jquery'));
