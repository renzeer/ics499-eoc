...
class evolve_Tabs_Widget extends WP_Widget {
	...
	function evolve_Tabs_Widget()
	{
		$widget_ops = array('classname' => 'evolve_tabs', 'description' => 'Popular posts, recent post and comments.');

		$control_ops = array('id_base' => 'evolve_tabs-widget');

		$this->WP_Widget('evolve_tabs-widget', 'evolve: Tabs', $widget_ops, $control_ops);
	}
						...
						<ul class="news-list">
							...
							<li>
								...
								<div class="post-holder">
									...
									<div class="meta">
									<?php echo evltruncate(strip_tags($comment->com_excerpt), 70); ?>
									</div>
								</div>
							</li>
							<?php } ?>
