...
?>
        ...
        <div id="secondary" class="aside <?php if (($evolve_layout == "1c")) {} if (($evolve_layout == "3cm" || $evolve_layout == "3cl" || $evolve_layout == "3cr")) {echo 'col-xs-12 col-sm-6 col-md-3';} else {echo 'col-sm-6 col-md-2';} ?>">
